...
public class F {
    ...
    void solve() throws IOException {
        ...
        int tissues = 3 * n / 2;
        int male = 0;
        for (int i = n + 1; i <= tissues; i++) {
            male++;
            for (int female = 1; female <= n; female++) {
                out.println(male + " " + female + " 2 " + i + " 0 " + female + " 0");
            }
        }
        male++;
        for (int female = 1; female <= n; female++) {
            out.println(male + " " + female + " 1 " + female + " 0");
        }
        for (int i = n + 1; i <= tissues; i++) {
            male++;
            if (male > n) break;
            for (int female = 1; female <= n; female++) {
                out.println(male + " " + female + " 2 " + i + " 1 " + female + " 0");
            }
        }
    }
