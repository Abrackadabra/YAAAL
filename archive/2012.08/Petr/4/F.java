    ...
    void solve() throws IOException {
        ...
        for (int i = 0; i < m; i++) {
            ...
            for (int j = 0; j < k; j++) {
                boolean done = false;
                if (pos < fourth && !done) {
                    layer = thickness + thickness - 1 - layer;
                    pos = fourth - pos - 1;
                    done = true;
                }
                if (pos >= fourth * 3 && !done) {
                    layer = thickness + thickness - 1 - layer;
                    pos = fourth * 2 - Math.abs(fourth * 3 - pos - 1);
                    done = true;
                }
                if (pos >= fourth && pos < fourth * 3 && !done) {
                    pos -= fourth;
                    done = true;
                }
                thickness *= 2;
